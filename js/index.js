...
[].forEach.call(oLis, function () {
    arguments[0].index = arguments[1];  //arguments[移动端简历]把当前元素的索引赋值给arguments[0].index 当前元素的自定义属性index
...
function move(e) {
    ...
    /*var step = 移动端简历/3;
    var scalePos =(Math.abs(changePos)/winH)*step; //取changePos绝对值 / 设备高度 * step(移动端简历/2)*/
    [].forEach.call(oLis,function(){
    ...
    //把当前元素按照比例缩放  移动端简历- 是因为要从大到小缩放  translate 平移的距离
